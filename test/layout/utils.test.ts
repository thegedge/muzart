...
describe("utils", () => {
  describe("ancestorOfType", () => {
    it("returns the first ancestor element of the given type", () => {
    ...
    it("returns null when no ancestor of type found", () => {
      const a = elem(0, 0, 1, 1, { type: "A" });
      const b = elem(0, 0, 1, 1, { parent: a, type: "B" });
      const c = elem(0, 0, 1, 1, { parent: b, type: "C" });
  ...
  describe("toAncestorCoordinateSystem", () => {
    it("converts a descendant's relative box to the root coordinate system", () => {
    ...
    it("converts a descendant's relative box to a given ancestor type's coordinate system", () => {
      const a = elem(1, 2, 1, 1, { type: "A" });
      const b = elem(5, 10, 2, 2, { parent: a, type: "B" });
      const c = elem(10, 20, 3, 3, { parent: b, type: "C" });
    ...
    it("returns the element's box when the given ancestor type is the parent", () => {
      const a = elem(1, 2, 1, 1, { type: "A" });
      const b = elem(5, 10, 2, 2, { parent: a, type: "B" });
      const c = elem(10, 20, 3, 3, { parent: b, type: "C" });
  ...
  describe("minMap", () => {
    it("computes the min value from the given mapper function", () => {
      assert.equal(
    ...
    it("uses the given lessThan function to compare elements", () => {
      assert.equal(
        minMap(
          ["abc", "1234", "cx", "longish"],
          (s) => s.length,
  ...
  describe("numCharsToRepresent", () => {
    it("computes the correct number of characters to represent the given number", () => {
  ...
  describe("runs", () => {
    it("computes runs when the mapper always returns a boolean", () => {
      assert.equal(
    ...
    it("computes runs when the mapper always returns a number", () => {
      assert.equal(
    ...
    it("computes runs when the mapper sometimes returns undefined", () => {
      assert.equal(
