...
import { AccentStyle } from "@muzart/notation";
...
export class AboveStaff extends GridGroup<AnyLayoutElement> {
  ...
  private addInterMeasureStaffDecorations<T>(
    ...
    elementGenerator: (value: T, amount: number) => AnyLayoutElement,
    options?: {
      group?: string;
