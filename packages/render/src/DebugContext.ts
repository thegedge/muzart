import { type AnyLayoutElement, LINE_STROKE_WIDTH } from "@muzart/layout";
...
// TODO redo this to not need mobx
export class DebugContext {
  public enabled = import.meta.env.VITE_DEBUG_APP == "1";
  public highlightedElement: AnyLayoutElement | null = null;
  ...
  setHighlightedElement(element: AnyLayoutElement | null): void {
    this.highlightedElement = this.enabled ? element : null;
  }
